...
const Scratch3WeatherforecastBlocks = require('../../src/extensions/scratch3_weatherforecast/index.js');
...
test('pen', t => {
    ...
    vm.on('playgroundData', () => {
        ...
        /** @type {PenState} */
        const originalPenState = originalCat.getCustomState(Scratch3WeatherforecastBlocks.STATE_KEY);

        /** @type {PenState} */
        const clonePenState = cloneCat.getCustomState(Scratch3WeatherforecastBlocks.STATE_KEY);
