...
const Scratch3GenderOfPeopleBlocks = require('../../src/extensions/scratch3_genderofpeople/index.js');
...
test('pen', t => {
    ...
    vm.on('playgroundData', () => {
        ...
        /** @type {PenState} */
        const originalPenState = originalCat.getCustomState(Scratch3GenderOfPeopleBlocks.STATE_KEY);

        /** @type {PenState} */
        const clonePenState = cloneCat.getCustomState(Scratch3GenderOfPeopleBlocks.STATE_KEY);
