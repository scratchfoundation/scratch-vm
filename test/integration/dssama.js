...
const Scratch3DssamaBlocks = require('../../src/extensions/scratch3_dssama/index.js');
...
test('pen', t => {
    ...
    vm.on('playgroundData', () => {
        ...
        /** @type {PenState} */
        const originalPenState = originalCat.getCustomState(Scratch3DssamaBlocks.STATE_KEY);

        /** @type {PenState} */
        const clonePenState = cloneCat.getCustomState(Scratch3DssamaBlocks.STATE_KEY);
