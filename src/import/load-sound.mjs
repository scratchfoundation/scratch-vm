...
export const loadSoundFromAsset = function (sound, soundAsset, runtime, soundBank) {
    ...
    return runtime.audioEngine.decodeSoundPlayer({ ...sound, data: soundAsset.data }).then((soundPlayer) => {
...
export const loadSound = function (sound, runtime, soundBank) {
    ...
    return ((sound.asset && Promise.resolve(sound.asset)) || runtime.storage.load(runtime.storage.AssetType.Sound, md5, ext))
        .then((soundAsset) => {
